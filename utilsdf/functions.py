import re, datetime, sqlite3, random, string, asyncio, json, os, traceback
import io
...
buy_button = InlineKeyboardMarkup(
    [[InlineKeyboardButton("Lynix Checker ⚡", url="https://t.me/bhaskargg")]]
)
...
def symbol(symbol: str) -> str:
    href = f"<a href='https://t.me/bhaskargg'>{symbol}</a>"
    return href
...
def get_bin_info_of_database(bin: str) -> dict | None:
    ...
    except (sqlite3.OperationalError, sqlite3.DatabaseError, IndexError, KeyError):
        # Return None if database table doesn't exist or has issues
        return None
