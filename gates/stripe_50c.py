...
async def stripe_gate(cc, month, year, cvv):
    ...
    async with AsyncClient(
        ...
        # 1. Visit donation page to get session
        await session.get("https://www.wateraid.org/us/donate")
